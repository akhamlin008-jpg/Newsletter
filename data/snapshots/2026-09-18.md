# Data snapshot 2026-09-18 06:09 EDT
...
|---|---|---|---|---|---|---|---|
| US 2-year yield | 4.711 | 09-18 06:08 | **LIVE (~0 min old)** | +2.10 bp | 0.39 |  | cnbc:US2Y (unofficial feed) |
| US 10-year yield | 4.957 | 09-18 06:08 | **LIVE (~1 min old)** | +1.00 bp | 0.24 |  | cnbc:US10Y (unofficial feed) |
| 2s10s spread (10Y minus 2Y) | 0.246 | 09-18 06:08 | **LIVE (~0 min old)** | -1.10 bp | -0.36 |  | calc: cnbc:US10Y minus cnbc:US2Y (unofficial feed) |
...
| 3M SOFR futures implied rate (front) | FAILED | | | | | | yahoo:SR3=F -> no prior close before the current session (9.6s) |
| US dollar index (DXY) | 100.353 | 09-18 05:59 | **LIVE (~10 min old)** | +0.13 % (vs 2026-09-17) | 0.42 |  | yahoo:DX-Y.NYB (unofficial feed) |
| USD/JPY | 157.853 | 09-18 06:09 | **LIVE (~0 min old)** | +1.18 % (vs 2026-09-17) | 1.77 |  | yahoo:JPY=X (unofficial feed) |
| EUR/USD | 1.149 | 09-18 06:08 | **LIVE (~1 min old)** | +0.16 % (vs 2026-09-17) | 0.55 |  | yahoo:EURUSD=X (unofficial feed) |
...
| S&P 500 futures (ES) | 7,718.250 | 09-18 05:59 | **LIVE (~10 min old)** | +1.02 % (vs 2026-09-17) | 1.54 |  | yahoo:ES=F (unofficial feed) |
| Nasdaq 100 futures (NQ) | 29,847.250 | 09-18 05:59 | **LIVE (~10 min old)** | +1.36 % (vs 2026-09-17) | 1.32 |  | yahoo:NQ=F (unofficial feed) |
| Russell 2000 futures (RTY) | 2,895.500 | 09-18 05:59 | **LIVE (~10 min old)** | +0.68 % (vs 2026-09-17) | 0.84 |  | yahoo:RTY=F (unofficial feed) |
...
| VIX (spot) | 15.330 | 09-18 05:54 | **LIVE (~15 min old)** | -0.11 pts (vs 2026-09-17) | -0.10 |  | yahoo:^VIX (unofficial feed) |
| VIX futures (front month) | FAILED | | | | | | yahoo:VX=F -> YFTzMissingError: $VX=F: possibly delisted; no timezone found (7.7s) |
| WTI crude | 96.330 | 09-18 05:59 | **LIVE (~10 min old)** | -5.48 % (vs 2026-09-17) | -1.81 |  | yahoo:CL=F (unofficial feed) |
| Brent crude | 98.890 | 09-18 05:58 | **LIVE (~11 min old)** | -5.66 % (vs 2026-09-17) | -1.90 |  | yahoo:BZ=F (unofficial feed) |
| Gold | 4,416.400 | 09-18 05:59 | **LIVE (~10 min old)** | +0.38 % (vs 2026-09-17) | 0.28 |  | yahoo:GC=F (unofficial feed) |
| Copper | 6.644 | 09-18 05:59 | **LIVE (~10 min old)** | +0.87 % (vs 2026-09-17) | 0.53 |  | yahoo:HG=F (unofficial feed) |
...
**BTC**: price 78,088.92, 24h 2.30%, z 1.16
- kraken: funding (raw, units unverified) 0.92988381849725, OI 2237.574, OI change vs prior snapshot -1.62%
- hyperliquid: funding (raw, units unverified) 0.0000125, OI 36480.86998, OI change vs prior snapshot 1.02%

**ETH**: price 2,511.12, 24h 3.19%, z 1.12
- kraken: funding (raw, units unverified) 0.07623936777925, OI 35311.558, OI change vs prior snapshot 0.13%
- hyperliquid: funding (raw, units unverified) 0.0000125, OI 1035692.8553999993, OI change vs prior snapshot 1.27%


## Source errors

- yahoo:SR3=F -> no prior close before the current session (9.6s)
